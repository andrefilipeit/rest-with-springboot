...
import br.com.andrefilipeos.converter.mock.MockPerson;
...
public class DozerMapperConverterTest {
    ...
    @Before //Before the initialize the tests, creates a new instance of MockPerson. It's a constructor similar 
    public void setUp() {
    ...
    public void parseEntityToVOTest() {
        PersonVO output = DozerMapperConverter.parseObject(inputObject.mockEntity(), PersonVO.class);
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = DozerMapperConverter.parseListObjects(inputObject.mockEntityList(), PersonVO.class);
    ...
    public void parseVOToEntityTest() {
        Person output = DozerMapperConverter.parseObject(inputObject.mockVO(), Person.class);
        Assert.assertEquals(Long.valueOf(0L), output.getId());
        Assert.assertEquals("First Name Test0", output.getFirstName());
        Assert.assertEquals("Last Name Test0", output.getLastName());
        Assert.assertEquals("Addres Test0", output.getAddress());
    ...
    public void parserVOListToEntityListTest() {
        List<Person> outputList = DozerMapperConverter.parseListObjects(inputObject.mockVOList(), Person.class);
