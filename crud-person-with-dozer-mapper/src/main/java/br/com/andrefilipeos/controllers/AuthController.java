...
import br.com.andrefilipeos.security.AccountCredentialsVO;
import br.com.andrefilipeos.security.jwt.JwtTokenProvider;
import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;

@Api(value="Authorization Endpoints", description = "All endpoints for Authorization", tags = {"Authorization-endpoints"}) //Editting values from swagger UI
@RestController
@RequestMapping("/auth")
